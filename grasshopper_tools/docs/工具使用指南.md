...
```python
from grasshopper_tools import MMDParser, JSONGenerator, PlacementExecutor
...
#### 3. 創建群組
```python
from grasshopper_tools import GroupManager, ComponentManager
...
- [README.md](README.md) - 完整的使用說明和範例
- [example_usage.py](example_usage.py) - 使用範例代碼
